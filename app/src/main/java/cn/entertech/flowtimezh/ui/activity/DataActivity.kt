...
import cn.entertech.flowtimezh.ui.fragment.JournalFragment
import cn.entertech.flowtimezh.ui.fragment.JournalLargeFragment
...
//        }
        if (mRecordId != -1L) {
            ...
            var record = userLessonRecordDao.findRecordById(SettingManager.getInstance().userId, mRecordId)
