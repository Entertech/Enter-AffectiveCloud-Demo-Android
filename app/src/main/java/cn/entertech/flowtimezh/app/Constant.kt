...
class Constant {
    companion object {
        ...
        const val DEFAULT_LINK_HRV_REPORT_INFO =
            "https://www.notion.so/HRV-Graph-6f93225bf7934cb8a16eb6ba55da52cb"
        ...
        const val DEFAULT_LINK_EEG_REALTIME_INFO =
            "https://www.notion.so/EEG-b3a44e9eb01549c29da1d8b2cc7bc08d"
        const val DEFAULT_LINK_HR_REALTIME_INFO =
            "https://www.notion.so/Heart-Rate-4d64215ac50f4520af7ff516c0f0e00b"
        ...
        var EXTRA_LABEL_ID = "meditationId"
        ...
        const val SP_API_SERVER = "sp_api_server"
