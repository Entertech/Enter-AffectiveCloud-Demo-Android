...
import cn.entertech.flowtimezh.mvp.presenter.LogAuthPresenter
import cn.entertech.flowtimezh.mvp.presenter.LogPostPresenter
import cn.entertech.flowtimezh.mvp.view.LogAuthView
import cn.entertech.flowtimezh.mvp.view.LogPostView
...
class LogManager {
    ...
    companion object {
        ...
        const val LOG_EVENT_PERMISSION_ACCESS_BACKGROUND_LOCATION_APPLY =
            "Permission ACCESS_BACKGROUND_LOCATION apply"
        const val LOG_EVENT_PERMISSION_ACCESS_BACKGROUND_LOCATION_GRANTED =
            "Permission ACCESS_BACKGROUND_LOCATION granted"
        const val LOG_EVENT_PERMISSION_ACCESS_BACKGROUND_LOCATION_DENIED =
            "Permission ACCESS_BACKGROUND_LOCATION denied"
