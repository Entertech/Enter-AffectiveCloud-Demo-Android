...
import cn.entertech.flowtimezh.app.Constant.Companion.BASE_URL
import cn.entertech.flowtimezh.utils.httplog.HttpLogger
...
class RetrofitHelper(context: Context) {
    ...
    fun getOtherServer(url: String): OtherService {
        var mRetrofit = Retrofit.Builder()
            ...
            .addCallAdapterFactory(RxJava2CallAdapterFactory.create())
            .build()
        return mRetrofit!!.create(OtherService::class.java)
    }
